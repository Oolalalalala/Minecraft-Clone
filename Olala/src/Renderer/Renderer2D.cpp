...
namespace Olala {
    ...
    void Renderer2D::Init()
    {
        // Quads
        {
            ...
            s_Data.QuadVertexArray->SetLayout({
            ...
            s_Data.QuadVertexArray->AddBuffer(s_Data.QuadVertexBuffer, IndexBuffer::Create(indices, indexCount));
            delete[] indices;
        ...
        // Circles
        {
            ...
            s_Data.CircleVertexArray->SetLayout({
                { "a_Position"       , ShaderDataType::Float3 },
            ...
            s_Data.CircleVertexArray->AddBuffer(s_Data.CircleVertexBuffer, IndexBuffer::Create(indices, indexCount));
            delete[] indices;
    ...
    uint32_t Renderer2D::WriteQuadDataToBuffer(std::vector<uint32_t>& quadIndices, int textureIndex)
    {
